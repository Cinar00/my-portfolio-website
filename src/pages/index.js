...
import computerSvg from "../../public/images/svgs/computers.svg";
  ...
  return (
    <>
      ...
      <main className="flex items-center text-dark dark:text-light w-full min-h-screen">
        ...
        <HireMe />
        <div className="absolute right-8 bottom-6 inline-block w-60 md:hidden">
          <Image src={computerSvg} alt="Cinar" className="w-full h-auto" />
        </div>
      </main>
    </>
  );
